...
%     straight direction
function [f, L, left, right] = mextractor(length, B0)

    global m q G c MeV W0
    
    f = @(s, X)emfunction(s, X, 0, @(t,x,y,s)Ex(t,x,y,s), @(t,x,y,s)Ey(t,x,y,s), @(t,x,y,s)Es(t,x,y,s), @(t,x,y,s)Bx(t,x,y,s), @(t,x,y,s)By(t,x,y,s, B0), @(t,x,y,s)Bs(t,x,y,s));
    L = length;
